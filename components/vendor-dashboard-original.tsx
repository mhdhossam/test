...
const VendorDashboard: React.FC = () => {
  ...
  const updateProduct = async (productId: number, productData: Product, file: File | null) => {
    try {
      ...
      setLoading(true)
      await axios.patch(`${API_BASE_URL}/api/store/product/update/${productId}/`, formData, {
        headers: {
  ...
  const deleteProduct = async (productId: number) => {
    ...
    setLoading(true)
    try {
      await axios.delete(`${API_BASE_URL}/api/store/product/delete/${productId}/`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
        },
      })
                  ...
                  <>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => updateProduct(currentEditProduct.id, currentEditProduct, selectedFile)}
                      >
                        Save
                      </button>
                      <button className="action-btn cancel-btn" onClick={() => setCurrentEditProduct(null)}>
                        Cancel
                      </button>
                    </td>
                    <td>
